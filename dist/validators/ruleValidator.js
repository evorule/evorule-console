...
export class RuleValidator {
     ...
     */
    static checkIoTwoPhase(value, errors) {
        if (!value.transform || !Array.isArray(value.transform))
            return;
        const checkRule = (rule, path, inIoResultCheck) => {
            if (!rule || typeof rule !== 'object')
                return;
        ...
        value.transform.forEach((rule, i) => {
     ...
     */
    static checkDomainTypes(value, errors) {
        const checkDomain = (domain, path) => {
     ...
     */
    static checkFallbackRule(value, errors) {
     ...
     */
    static checkRecursionDepth(value, errors) {
        const checkDepth = (obj, depth, path) => {
