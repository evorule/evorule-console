...
export function injectBackend(backend) {
    ...
    ttdApi.command = async (id, instruction) => {
    ...
    ttdApi.fork = async (parentId, version) => {
 ...
 */
export async function syncSessionToTtd(sessionId) {
