 ...
 */
export function provideAssistant(provider = null) {
    setContext(ASSISTANT_CONTEXT_KEY, provider);
    return provider;
}
/**
 ...
 * ```
 */
export function useAssistantOrNull() {
    if (!hasContext(ASSISTANT_CONTEXT_KEY))
        return null;
    return getContext(ASSISTANT_CONTEXT_KEY);
}
