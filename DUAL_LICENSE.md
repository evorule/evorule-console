...
# evorule-console 双重许可说明

**版本**: 1.0
**生效日期**: 2026-08-03
**适用范围**: evorule-console(EvoRule 生态产品)

---

## 概述

evorule-console 采用**双轨许可模式**,为不同项目方提供灵活选择:
...
**A**: 不需要。如果您是个人使用、学习、内部工具,AGPL-3.0 即可。如果您把基于 evorule-console 的服务卖给客户,**才**需要商业许可。

### Q6: 大众版 / 高级版基于 evorule-console,它们的商业许可怎么算?

**A**: evorule-console 是衍生产品(大众版/高级版)的共同基础。衍生产品各自有独立的商业许可策略,由其所在仓决定。本文件只约束 evorule-console 仓本身。
...
evorule-console 的知识产权归 EvoRule Project 所有。
...
| 版本 | 日期 | 变更说明 |
|---|---|---|
| 1.0 | 2026-08-03 | 初版,适配 evorule-console v0.1.0 |
